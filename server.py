...
def status(param):
	...
	# bot.send_message(param["param"]["telegram"], param["param"]["score"])
	bot.edit_message_text(chat_id=param["param"]["telegram"], message_id=message_id[telegram]['message_id']+1, text=param["param"]["score"])
	return ['Success']
