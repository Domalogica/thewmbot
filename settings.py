...
ID 821 пр.Петра Первого 49д [вр. не работает | подключен бот]
ID 921 ул.Ирчи Казака 49к4
ID 1021 пр.Гамидова 49к7  
ID 1121 пр.А.Султана 10и [вр. не работает | подключен бот]
ID 1221 ул.Газопроводная 107б 
ID 1321 пр.Акушинского 31
ID 1421 пр.Акушинского 11е
ID 1521 Индустриальный пр. 6в [вр. не работает | подключен бот]
"""
opp = "🤦"
