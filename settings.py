...
wada = """
ID 121 пр.Акушинского 30 [подключен бот]
ID 221 ул.Научный городок 1 [подключен бот]
ID 321 пр.Гамидова 81 [подключен бот]
ID 421 пр.А.Султана 1 [подключен бот]
ID 521 ул.Батырая 136л [подключен бот]
ID 621 пр.Акушинского 28 [подключен бот]
ID 721 пр.Насрутдинова 107 [подключен бот]
ID 821 пр.Петра Первого 49д [вр. не работает]
ID 921 ул.Ирчи Казака 49к4 [подключен бот]
ID 1021 пр.Гамидова 49к7 [подключен бот]
ID 1121 пр.А.Султана 10и [вр. не работает]
ID 1221 ул.Газопроводная 107б [подключен бот]
ID 1321 пр.Акушинского 31 [подключен бот]
ID 1421 пр.Акушинского 11е [подключен бот]
